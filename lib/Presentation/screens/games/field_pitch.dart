...
class Field extends StatelessWidget {
  const Field({Key? key, required this.team1, required this.team2})
      : super(key: key);
            ...
            child: Column(
              children: [
                ...
                Row(
                  ...
                  children: [
                    Expanded(child: PlayerIcon(team1_color, 1, team1[0])),
                  ],
                ),
                SizedBox(
            ...
            child: Column(
              ...
              children: [
                ...
                Row(
                  ...
                  mainAxisAlignment: MainAxisAlignment.center,
                  children: [
                    Expanded(child: PlayerIcon(team2_color, 1, team2[0])),
                  ],
                ),
                SizedBox(
                  height: MediaQuery.of(context).size.width * 0.04,
...
class PlayerIcon extends StatelessWidget {
  ...
  int field_no;
  int player_id;
  PlayerIcon(this.color1, this.field_no, this.player_id);
            ...
            showModalBottomSheet<void>(
              ...
              builder: (BuildContext context) {
                return FractionallySizedBox(
                  heightFactor: 0.85,
                  child: RatePlayerFormWindow(player_id),
                );
              },
            );
          },
...
class RatePlayerFormWindow extends StatelessWidget {
  ...
  int player_id;
  RatePlayerFormWindow(this.player_id);

  @override
  Widget build(BuildContext context) {
    return BlocProvider(
      create: (context) => ParameterBloc()..add(GetAllParameters(1)),
                    ...
                    child: Column(children: <Widget>[
                      Column(
                        ...
                        (index) => FormBuilderSlider(
                          name:
                              state.parameter['skills'][index]['id'].toString(),
                          min: 0.0,
                          max: 10.0,
                          initialValue: 4.0,
                          divisions: 20,
                          ...
                          decoration: InputDecoration(
                            labelText: state.parameter['skills'][index]['name']
                                .toString(),
                          ),
                        ),
                      )),
                              ...
                              child: MaterialButton(
                                ...
                                onPressed: () {
                                  ...
                                  if (_formKey.currentState != null) {
                                    Grade grade = Grade(
                                        eventId: state.parameter['event']['id'],
                                        player: player_id,
                                        scoutId: 145,
                                        score: _formKey.currentState?.value);
                                    GradeBloc()..add(GradePlayer(grade));
